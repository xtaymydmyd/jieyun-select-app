<template>
    <div class="result" >
        <div class="userWrap vux-1px-b">
            <!-- 人员列表 -->
            <div class="userWrapBlock flex" v-if="withUser == 1">
                <div 
                    class="block"
                    ...
                    <div class="flex flex-direction-column flex-align-items">
                        <img src="~select/assets/img/headmr.png" class="headImg" v-if="item.headImgUrl == null || item.headImgUrl == ''"> 
            ...
            <div class="userWrapBlock flex" v-if="withUser == 2">
                <div 
                    ...
                    <div class="flex flex-direction-column flex-align-items">
                        <!-- <img src="~select/assets/img/icon.png" class="headImg"> -->
