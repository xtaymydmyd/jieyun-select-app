...
import result from 'select/components/selectComponent/result.vue'

/* 部门、岗位、群组列表 */
import selectContainer from 'select/components/selectComponent/selectContainer.vue'
/* 部门 */
import deptAndMemList from 'select/components/selectComponent/deptAndMemList.vue'
/* 岗位 */
import postAndMenList from 'select/components/selectComponent/postAndMenList.vue'
/* 群组 */
import goupAndMemList from 'select/components/selectComponent/goupAndMemList.vue'
/* 搜索结果 */
import searchMemList from 'select/components/selectComponent/searchMemList.vue'
...
<style lang="scss">
    @import "~select/assets/css/index.scss";
    @import "~select/assets/css/condition.scss";
    .selectMain{
        // .editGroup{
        //     position: absolute;
        //     bottom: 150px;
